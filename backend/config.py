...
class Settings(BaseSettings):
    ...
    # Persistence filter — self-learning static-source (industrial heat)
    # suppression from detection history, following NASA's STA-mask method.
    PERSISTENCE_FILTER_ENABLED: bool = True
    PERSISTENCE_MIN_DISTINCT_DAYS: int = 5   # distinct days -> flagged static (NASA uses 5)
    ...
    INDUSTRIAL_FILTER_BUFFER_KM: float = 1.0
