...
- Satellite thermal detections can include non-fire heat sources and can
  miss fires hidden by cloud or dense canopy.
...
- Routing avoids only *detected* fire zones and depends on third-party road
  ...
  provider.
- French and Arabic text is a functional translation and should be reviewed
  by a native speaker before any operational use.
